...
RSpec.describe SearchCircles     do  #, focus: true

  describe '- test SearchCircles methods - ' do
    # create model data
    before {
      #Counters
    ...
    context '- Check method: have_profile_circle(profile_id, user_id) - '  , focus: true  do   #   , focus: true
      ...
      let(:profile) { Profile.where(id: profile_id, deleted: 0)[0] }
      let(:circle_arrays) { SearchCircles.have_profile_circle(profile_id) }
