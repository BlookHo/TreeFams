...
RSpec.describe WeafamStat, type: :model  do
  ...
  describe '- test WeafamStat methods - ' do
    # create model data
    before {
      ...
      # puts "before All: User.user_7 = #{User.find(7).id}, .connected_users = #{User.find(7).connected_users} \n"
      # # user_id = 7

      # ConnectedUser    # after_update  :update_connected_users
