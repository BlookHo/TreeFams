...
class TreesControllerTest < ActionController::TestCase
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post :create, tree: { connected: @tree.connected, profile_id: @tree.profile_id, relation_id: @tree.relation_id, user_id: @tree.user_id }
    end
  ...
  test "should update tree" do
    patch :update, id: @tree, tree: { connected: @tree.connected, profile_id: @tree.profile_id, relation_id: @tree.relation_id, user_id: @tree.user_id }
    assert_redirected_to tree_path(assigns(:tree))
  end
