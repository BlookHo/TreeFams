module SearchSoft
 ...
 #   ]
   ...
   #     [
    ...
    #[{4=>{16=>{28=>[1, 2, 5, 5, 8, 3], 27=>[3, 3]}}},
    # {4=>{17=>{27=>[3, 8, 3, 3], 25=>[8], 28=>[3]}}},
    # {4=>{18=>{24=>[7, 3, 3, 3], 26=>[7]}}},
    # {4=>{19=>{30=>[1, 2, 5, 5]}}},
    # {4=>{20=>{29=>[1, 2, 5, 5], 32=>[1]}}},
    # {4=>{21=>{33=>[7, 3]}}},
    # {4=>{22=>{28=>[1, 5]}}},
    # {4=>{23=>{29=>[1, 5], 32=>[1, 2]}}}]

    [{9=>{72=>{57=>[2, 3, 3], 71=>[2], 58=>[8, 3, 3, 3], 68=>[8, 3, 3, 3]}},
      10=>{72=>{57=>[2, 3, 3], 71=>[2], 58=>[8, 3, 3, 3], 68=>[8, 3, 3, 3]}}},
     {9=>{74=>{59=>[3], 65=>[3]}},
      10=>{74=>{59=>[3], 65=>[3]}}},
     {9=>{75=>{59=>[7, 3, 3, 3], 65=>[7, 3, 3, 3]}},
      10=>{75=>{59=>[7, 3, 3, 3], 65=>[7, 3, 3, 3]}}},
     {9=>{76=>{61=>[1, 2, 5, 5], 69=>[1, 2, 5, 5]}},
      10=>{76=>{61=>[1, 2, 5, 5], 69=>[1, 2, 5, 5]}}},
     {9=>{77=>{60=>[1, 2, 5, 5], 64=>[1, 5], 70=>[1, 2, 5, 5]}},
      10=>{77=>{60=>[1, 2, 5, 5], 64=>[1, 5], 70=>[1, 2, 5, 5]}}},
     {9=>{78=>{57=>[1, 2, 5, 5], 63=>[1, 5], 71=>[1, 2, 5, 5]}},
      10=>{78=>{57=>[1, 2, 5, 5], 63=>[1, 5], 71=>[1, 2, 5, 5]}}}]


     [{57=>{71=>[1, 2, 5, 5], 78=>[1, 2, 5, 5, 8], 72=>[2, 3, 3], 68=>[3, 3]}},
     {58=>{68=>[3, 8, 3, 3], 72=>[3, 8, 3, 3, 1, 2], 71=>[2], 78=>[2]}},
     {59=>{65=>[7, 3, 3, 3], 75=>[7, 3, 3, 3], 74=>[3]}},
     {60=>{70=>[1, 2, 5, 5], 77=>[1, 2, 5, 5]}},
     {61=>{69=>[1, 2, 5, 5], 76=>[1, 2, 5, 5]}},
     {62=>{79=>[7]}},
     {63=>{71=>[1, 5], 78=>[1, 5]}},
     {64=>{70=>[1, 5], 77=>[1, 5]}},
     {80=>{73=>[3, 8]}},
    ...
    [{65=>{59=>[1, 7, 3, 3, 3], 75=>[7, 3, 3, 3], 74=>[3], 81=>[3]}},
     {66=>{82=>[4]}},
     {68=>{58=>[8, 3, 3, 3, 1, 2], 72=>[8, 3, 3, 3, 1, 2], 57=>[3, 3, 2], 78=>[2]}},
     {69=>{61=>[2, 1, 5, 5], 76=>[2, 1, 5, 5]}},
     {70=>{60=>[2, 1, 5, 5], 77=>[2, 1, 5, 5], 64=>[1, 5], 73=>[8], 80=>[8]}},
     {71=>{57=>[2, 1, 5, 5, 8, 3], 72=>[2, 3], 78=>[2, 1, 5, 5, 8], 58=>[2, 3], 63=>[1, 5]}},
     {83=>{74=>[7], 81=>[7]}},
     {84=>{73=>[3, 8], 80=>[3, 8]}},
     {85=>{59=>[3], 74=>[3, 7], 75=>[3], 81=>[3, 7]}},
     {86=>{62=>[7, 3], 79=>[7]}},
     {87=>{60=>[1], 64=>[1, 2], 77=>[1]}}]
...
# 9
  ...
  def soft_search_match(connected_users, from_profile_searching, profile_id_searched, relation_id_searched)
    ...
    @new_profiles_found_arr << new_found_profiles_hash if !new_found_profiles_hash.blank? # Заполнение выходного массива хэшей
    @new_profiles_to_profiles_arr
    ...
    # @new_wide_match_profiles_arr = @new_wide_match_profiles_arr # DEBUGG TO VIEW
