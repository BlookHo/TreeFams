...
module ProfileQuestions
  ...
  def make_questions(user_id, profile_id, relation_add_to, relation_added, name_id_added, author_profile_id, user_ids)
    ...
    #@incoming_author_profile_id
    #= author_profile_id # автор текущего круга
    ...
    logger.info "== before case: relation_add_to = #{relation_add_to} "
    case relation_add_to
      ...
      when 3, 4
        check_son_daughter_relations(relation_add_to, relation_added, name_id_added)
      when 5, 6
        check_brother_sister_relations(relation_add_to, relation_added, name_id_added)
      when 7, 8
        check_husband_wife_relations(relation_add_to, relation_added, name_id_added)
      else
  ...
  # в завис-ти от добавляемого relation
  def check_brother_sister_relations(relation_add_to, relation_added, added_name_id)
    case relation_added
      when 1 # add new father
        ask_brother_sister_questions(1, relation_add_to, added_name_id)
      when 2 # add new mother
        ask_brother_sister_questions(2, relation_add_to, added_name_id)
      when 5 # add new brother
        ask_brother_sister_questions(5, relation_add_to, added_name_id)
      when 6 # add new sister
        ask_brother_sister_questions(6, relation_add_to, added_name_id)
      else  # все остальные relation_added - создают стандартные ситуации
  ...
  # в завис-ти от добавляемого relation
  def check_son_daughter_relations(relation_add_to, relation_added, added_name_id)
    case relation_added
      when 1 # add new father
        ask_son_daughter_questions(1, relation_add_to, added_name_id)
      when 2 # add new mother
        ask_son_daughter_questions(2, relation_add_to, added_name_id)
      when 5 # add new brother
        ask_son_daughter_questions(5, relation_add_to, added_name_id)
      when 6 # add new sister
        ask_son_daughter_questions(6, relation_add_to, added_name_id)
      else  # все остальные relation_added - создают стандартные ситуации
  ...
  # в завис-ти от добавляемого relation
  def check_husband_wife_relations(relation_add_to, relation_added, added_name_id)
    case relation_added
      when 3 # add new son
        ask_husband_wife_questions(3, relation_add_to, added_name_id)
      when 4 # add new daughter
        ask_husband_wife_questions(4, relation_add_to, added_name_id)
      when 7 # add new husband
        ask_husband_wife_questions(7, relation_add_to, added_name_id)
      when 8 # add new wife
        ask_husband_wife_questions(8, relation_add_to, added_name_id)
      else  # все остальные relation_added - создают стандартные ситуации
  ...
  #
  def make_one_question(one_question_name, add_to_author, text_relation_add_to, author_profile_id, one_question_profile, added_relation, added_name, text_relation, profile_relation, which_string_1, which_string_2)
  ...
  def add_relation_questions(names_hash, text_relation_add_to, add_to_author, added_name_id, added_relation, text_relation, profile_relation)
    ...
    #text_relation_add_to = "Отец"
    #text_relation_add_to = "Мать"
    if !names_hash.blank?
      ...
      if !names_arr.blank?
        ...
        for arr_ind in 0 .. names_arr.length - 1
          one_question = make_one_question(names_arr[arr_ind], add_to_author, inflect_text_relation_add_to, @tmp_author_profile_id, profiles_arr[arr_ind], inflect_added_relation, inflect_added_name, inflect_text_relation, inflect_profile_relation, which_string_1, which_string_2)
  ...
  def ask_author_questions(added_relation, added_name_id) # 0
    ...
    case added_relation
      when 1  # Добавляем Отца к Автору - то же, что 5,6 - 1
        ...
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, "", true, added_name_id, "Отец", "Отец", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, "", true, added_name_id, "Отец", "Отец", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@mothers_hash, "", true, added_name_id, "Отец", "Муж", "Мать"))
      when 2  # Добавляем Мать к Автору - то же, что 5,6 - 2
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, "", true, added_name_id, "Мать", "Мать", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, "", true, added_name_id, "Мать", "Мать", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@fathers_hash, "", true, added_name_id, "Мать", "Жена", "Отец"))
      when 7  # Добавляем Мужа к Автору (женщине)
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, "", true, added_name_id, "Муж", "Отец", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, "", true, added_name_id, "Муж", "Отец", "Дочь"))
      when 8  # Добавляем Жену к Автору (мужчине)
        logger.info "== in case 8  - ask_author_questions: added_relation = #{added_relation} "
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, "", true, added_name_id, "Жена", "Мать", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, "", true, added_name_id, "Жена", "Мать", "Дочь"))
      else
        "Неизвестно"
    end
  ...
  def ask_father_questions(added_relation, added_name_id) # 1
    ...
    case added_relation
      when 3  # Добавляем Сына к Отцу
        ...
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, "Отец", false, added_name_id, "Сын", "Брат", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, "Отец", false, added_name_id, "Сын", "Брат", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@mothers_hash, "Отец", false, added_name_id, "Сын", "Сын", "Мать"))
        @standard_msg = "Добавляем Сына к Отцу"
        logger.info "============================== in 3 ask #{@brothers_hash}"
      when 4  # Добавляем Дочь к Отцу
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, "Отец", false, added_name_id, "Дочь", "Сестра", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, "Отец", false, added_name_id, "Дочь", "Сестра", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@mothers_hash, "Отец", false, added_name_id, "Дочь", "Дочь", "Мать"))
      when 8  # Добавляем Жену к Отцу
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, "Отец", false, added_name_id, "Жена", "Мать", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, "Отец", false, added_name_id, "Жена", "Мать", "Сестра"))
      else
        "Неизвестно"
    end
    @non_standard_questions_hash = non_standard_questions_hash   #
  ...
  def ask_mother_questions(added_relation, added_name_id) # 2
    ...
    case added_relation
      when 3  # Добавляем Сына к Матери
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, "Мать",false, added_name_id, "Сын", "Брат", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, "Мать",false, added_name_id, "Сын", "Брат", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@fathers_hash, "Мать",false, added_name_id, "Сын", "Сын", "Отец"))
        @standard_msg = "Добавляем Сына к Матери (Автора)"
      when 4  # Добавляем Дочь к Матери
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, "Мать",false, added_name_id, "Дочь", "Сестра", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, "Мать",false, added_name_id, "Дочь", "Сестра", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@fathers_hash, "Мать",false, added_name_id, "Дочь", "Дочь", "Отец"))
      when 7  # Добавляем Мужа к Матери
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, "Мать",false, added_name_id, "Муж", "Отец", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, "Мать", false, added_name_id, "Муж", "Отец", "Сестра"))
      else
        "Неизвестно"
    end
    @non_standard_questions_hash = non_standard_questions_hash   #
  ...
  # В зависимости от того, какое relation добавляем,
  # заполняются те массивы вопросов, которые следует задавать
  def ask_brother_sister_questions(added_relation, relation_add_to, added_name_id) # 5, 6
    non_standard_questions_hash = Hash.new

    relation_name = ""
    relation_name = "Брат" if relation_add_to == 5
    relation_name = "Сестра" if relation_add_to == 6

    case added_relation
      when 1  # Добавляем Отца к Брату/Сестре - то же, что 0 - 1
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, relation_name, false, added_name_id, "Отец", "Отец", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, relation_name, false, added_name_id, "Отец", "Отец", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@mothers_hash, relation_name, false, added_name_id, "Отец", "Муж", "Мать"))
      when 2  # Добавляем Мать к Брату/Сестре - то же, что 0 - 2
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, relation_name, false, added_name_id, "Мать", "Мать", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, relation_name, false, added_name_id, "Мать", "Мать", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@fathers_hash, relation_name, false, added_name_id, "Мать", "Жена", "Отец"))
        @standard_msg = "Добавляем Мать к Брату/Сестре"
      when 5  # Добавляем к Брата к Брату/Сестре
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, relation_name, false, added_name_id, "Брат", "Брат", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, relation_name, false, added_name_id, "Брат", "Брат", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@fathers_hash, relation_name, false, added_name_id, "Брат", "Сын", "Отец"))
        non_standard_questions_hash.merge!(add_relation_questions(@mothers_hash, relation_name, false, added_name_id, "Брат", "Сын", "Мать"))
      when 6  # Добавляем к Сестру к Брату/Сестре
        non_standard_questions_hash.merge!(add_relation_questions(@brothers_hash, relation_name, false, added_name_id, "Сестра", "Сестра", "Брат"))
        non_standard_questions_hash.merge!(add_relation_questions(@sisters_hash, relation_name, false, added_name_id, "Сестра", "Сестра", "Сестра"))
        non_standard_questions_hash.merge!(add_relation_questions(@fathers_hash, relation_name, false, added_name_id, "Сестра", "Дочь", "Отец"))
        non_standard_questions_hash.merge!(add_relation_questions(@mothers_hash, relation_name, false, added_name_id, "Сестра", "Дочь", "Мать"))
      else
        "Неизвестно"
    end
    @non_standard_questions_hash = non_standard_questions_hash   #
  ...
  # В зависимости от того, какое relation добавляем,
  # заполняются те массивы вопросов, которые следует задавать
  def ask_son_daughter_questions(added_relation, relation_add_to, added_name_id) # 3, 4
    non_standard_questions_hash = Hash.new
    relation_name = ""
    relation_name = "Сын" if relation_add_to == 3
    relation_name = "Дочь" if relation_add_to == 4

    case added_relation
      when 1  # Добавляем Отца к Сыну/Дочери - то же, что
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, relation_name, false, added_name_id, "Отец", "Отец", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, relation_name, false, added_name_id, "Отец", "Отец", "Дочь"))
        non_standard_questions_hash.merge!(add_relation_questions(@wives_hash, relation_name, false, added_name_id, "Отец", "Муж", "Жена"))
        @standard_msg = "Добавляем Отца к Сыну/Дочери"
      when 2  # Добавляем Мать к Сыну/Дочери - то же, что
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, relation_name, false, added_name_id, "Мать", "Мать", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, relation_name, false, added_name_id, "Мать", "Мать", "Дочь"))
        non_standard_questions_hash.merge!(add_relation_questions(@husbands_hash, relation_name, false, added_name_id, "Мать", "Жена", "Муж"))
        @standard_msg = "Добавляем Мать к Сыну/Дочери"
      when 5  # Добавляем Брата к Сыну/Дочери
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, relation_name, false, added_name_id, "Брат", "Брат", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, relation_name, false, added_name_id, "Брат", "Брат", "Дочь"))
        non_standard_questions_hash.merge!(add_relation_questions(@husbands_hash, relation_name, false, added_name_id, "Брат", "Сын", "Муж"))
        non_standard_questions_hash.merge!(add_relation_questions(@wives_hash, relation_name, false, added_name_id, "Брат", "Сын", "Жена"))
      when 6  # Добавляем Сестру к Сыну/Дочери
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, relation_name, false, added_name_id, "Сестра", "Сестра", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, relation_name, false, added_name_id, "Сестра", "Сестра", "Дочь"))
        non_standard_questions_hash.merge!(add_relation_questions(@husbands_hash, relation_name, false, added_name_id, "Сестра", "Дочь", "Муж"))
        non_standard_questions_hash.merge!(add_relation_questions(@wives_hash, relation_name, false, added_name_id, "Сестра", "Дочь", "Жена"))
      else
        "Неизвестно"
    end
    @non_standard_questions_hash = non_standard_questions_hash   #
  ...
  # В зависимости от того, какое relation добавляем,
  # заполняются те массивы вопросов, которые следует задавать
  def ask_husband_wife_questions(added_relation, relation_add_to, added_name_id) # 7,8
    non_standard_questions_hash = Hash.new
    relation_name = ""
    relation_name = "Муж" if relation_add_to == 7
    relation_name = "Жена" if relation_add_to == 8

    case added_relation
      when 3  # Добавляем Сына к Мужу/Жене
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, relation_name, false, added_name_id, "Сын", "Брат", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, relation_name, false, added_name_id, "Сын", "Брат", "Дочь"))
        non_standard_questions_hash.merge!(add_relation_questions(@wives_hash, relation_name, false, added_name_id, "Сын", "Сын", "Жена"))
        non_standard_questions_hash.merge!(add_relation_questions(@husbands_hash, relation_name, false, added_name_id, "Сын", "Сын", "Муж"))
        @standard_msg = "Добавляем Сына к Мужу/Жене"
      when 4  # Добавляем Дочь к Мужу/Жене
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, relation_name, false, added_name_id, "Дочь", "Сестра", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, relation_name, false, added_name_id, "Дочь", "Сестра", "Дочь"))
        non_standard_questions_hash.merge!(add_relation_questions(@wives_hash, relation_name, false, added_name_id, "Дочь", "Дочь", "Жена"))
        non_standard_questions_hash.merge!(add_relation_questions(@husbands_hash, relation_name, false, added_name_id, "Дочь", "Дочь", "Муж"))
        @standard_msg = "Добавляем Дочь к Мужу/Жене"
      when 7  # Добавляем Мужа к Жене
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, relation_name, false, added_name_id, "Муж", "Отец", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, relation_name, false, added_name_id, "Муж", "Отец", "Дочь"))
      when 8  # Добавляем Жену к Мужу
        non_standard_questions_hash.merge!(add_relation_questions(@sons_hash, relation_name, false, added_name_id, "Жена", "Мать", "Сын"))
        non_standard_questions_hash.merge!(add_relation_questions(@daughters_hash, relation_name, false, added_name_id, "Жена", "Мать", "Дочь"))
      else
        "Неизвестно"
    end
    @non_standard_questions_hash = non_standard_questions_hash   #
