module Search
  ...
  # def clear_prev_results(found_tree_ids)
  ...
  #   SearchResults.clear_prev_results(by_trees)
  ...
  #   SearchResults.store_results(SearchResults.collect_tree_ids(by_trees), by_profiles, current_user_tree_ids)
  ...
  # def get_one_result(one_profiles_hash)
  ...
  # def collect_result_arrs(results_arrs, one_result)
