class GraphTreeController < ApplicationController
  ...
  def show_graph_tree
    ...
    if user_signed_in?
      ...
      @profiles_json = '{"author":{"profile_id":1,"user_id":1,"name":"Корень","sex_id":0,"relation_id":0,"family":{"fathers":[{"profile_id":1,"user_id":1,"name":"Валера","sex_id":1,"relation_id":1}],"mothers":[{"profile_id":1,"user_id":1,"name":"Юлия","sex_id":2,"relation_id":2}],"wives":[{"profile_id":1,"user_id":1,"name":"Диана","sex_id":2,"relation_id":8}],"brothers":[{"profile_id":1,"user_id":1,"name":"Егор","sex_id":1,"relation_id":5},{"profile_id":1,"user_id":1,"name":"Иван","sex_id":1,"relation_id":5}],"sisters":[{"profile_id":1,"user_id":1,"name":"Ксюша","sex_id":2,"relation_id":6},{"profile_id":1,"user_id":1,"name":"Светлана","sex_id":2,"relation_id":6}],"sons":[{"profile_id":1,"user_id":1,"name":"Никита","sex_id":1,"relation_id":3},{"profile_id":1,"user_id":1,"name":"Василий","sex_id":1,"relation_id":3}],"daughters":[{"profile_id":1,"user_id":1,"name":"Вероника","sex_id":2,"relation_id":4},{"profile_id":1,"user_id":1,"name":"Кристина","sex_id":2,"relation_id":4}]}}}'
