class GraphTreeController < ApplicationController
  ...
  def show_graph_tree
    ...
    if user_signed_in?
      ...
      #@profiles_json = '{"author":{"name":"Алексей","sex_id":1,"relation_id":0,"family":{"fathers":[{"name":"Сергей","sex_id":1,"validation_context":null,"errors":{}}],"mothers":[{"name":"Алла","sex_id":0,"validation_context":null,"errors":{}}],"brothers":[],"sisters":[],"sons":[],"daughters":[],"husbands":[],"wives":[]}}}'
